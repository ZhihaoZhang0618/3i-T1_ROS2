...
LidarDriver::LidarDriver()
    : node_(rclcpp::Node::make_shared("ltme_node")), hibernation_requested_(false), quit_driver_(false)
{
  ...
  node_->declare_parameter("scan_frequency_override", rclcpp::PARAMETER_INTEGER);
  ...
  node_->get_parameter_or("scan_frequency_override", scan_frequency_override_, DEFAULT_SCAN_FREQUENCY);
...
void LidarDriver::run()
{
  ...
  rclcpp::Service<ltme_interfaces::srv::QuerySerial>::SharedPtr query_serial_service = node_->create_service<ltme_interfaces::srv::QuerySerial>("~/query_serial", std::bind(&LidarDriver::querySerialService, this, std::placeholders::_1, std::placeholders::_2));
  rclcpp::Service<ltme_interfaces::srv::QueryFirmwareVersion>::SharedPtr query_firmware_service = node_->create_service<ltme_interfaces::srv::QueryFirmwareVersion>("~/query_firmware_version", std::bind(&LidarDriver::queryFirmwareVersion, this, std::placeholders::_1, std::placeholders::_2));
  rclcpp::Service<ltme_interfaces::srv::QueryHardwareVersion>::SharedPtr query_hardware_service = node_->create_service<ltme_interfaces::srv::QueryHardwareVersion>("~/query_hardware_version", std::bind(&LidarDriver::queryHardwareVersion, this, std::placeholders::_1, std::placeholders::_2));
  rclcpp::Service<std_srvs::srv::Empty>::SharedPtr request_hibernation_service = node_->create_service<std_srvs::srv::Empty>("~/request_hibernation", std::bind(&LidarDriver::requestHibernationService, this, std::placeholders::_1, std::placeholders::_2));
  rclcpp::Service<std_srvs::srv::Empty>::SharedPtr request_wake_up_service = node_->create_service<std_srvs::srv::Empty>("~/request_wake_up", std::bind(&LidarDriver::requestWakeUpService, this, std::placeholders::_1, std::placeholders::_2));
  rclcpp::Service<std_srvs::srv::Empty>::SharedPtr quit_driver_service = node_->create_service<std_srvs::srv::Empty>("~/quit_driver", std::bind(&LidarDriver::quitDriverService, this, std::placeholders::_1, std::placeholders::_2));
